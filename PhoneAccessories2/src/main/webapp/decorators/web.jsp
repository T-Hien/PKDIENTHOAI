...
<link rel="shortcut icon" href="<c:url value="/templates/user/access/img/favicon.ico"/>">
...
<link rel="stylesheet" href="<c:url value="/templates/user/access/css/order.css"/>"/>
<link rel="stylesheet" href="<c:url value="/templates/user/access/css/customer.css"/>"/>
