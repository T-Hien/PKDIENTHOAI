window.onload = function () {
	...
	addBanner("http://localhost:8080//THIETKE//resources//img//banners//banner0.gif", "http://localhost:8080//THIETKE//resources//img//banners//banner0.gif");
	var numBanner = 9; // Số lượng hình banner
	for (var i = 1; i <= numBanner; i++) {
		var linkimg = "http://localhost:8080//THIETKE//resources//img//banners//banner" + i + ".png";
	...
	for (var c of company) addCompany("http://localhost:8080//THIETKE//resources//img//company/" + c, c.slice(0, c.length - 4));
