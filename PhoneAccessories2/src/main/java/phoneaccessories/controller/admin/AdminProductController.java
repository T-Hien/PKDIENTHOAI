...
public class AdminProductController {
	...
	public ModelAndView addProdcut(@ModelAttribute("addProdcut") Product product,
		...
		try {
			...
			File file = new File("C:\\Users\\Hoai Han\\Downloads\\PhoneAccessories1\\src\\main\\webapp\\templates\\images\\",
					fileName);
	...
	public ModelAndView editProduct(@ModelAttribute("product") Product product
		...
		try {
			...
			File file = new File("C:\\Users\\Hoai Han\\Downloads\\PhoneAccessories1\\src\\main\\webapp\\templates\\images\\",filename);
